function __bobthefish_colors -S -a color_scheme -d 'Define colors used by bobthefish'
    switch "$color_scheme"
        ...
        case 'terminal' 'terminal-dark*'
            set -l colorfg black
            [ "$color_scheme" = 'terminal-dark-white' ]
            and set colorfg white
        ...
        case 'terminal-light*'
            set -l colorfg white
            [ "$color_scheme" = 'terminal-light-black' ]
            and set colorfg black
        ...
        case 'terminal2' 'terminal2-dark*'
            set -l colorfg black
            [ "$color_scheme" = 'terminal2-dark-white' ]
            and set colorfg white
        ...
        case 'terminal2-light*'
            set -l colorfg white
            [ "$color_scheme" = 'terminal2-light-black' ]
            and set colorfg black
        ...
        case '*' # default dark theme
            #               light  medium dark
            #               ------ ------ ------
            set -l red cc9999 e06c75 c24038
            set -l green 98c379 98c379 6d8c56
            set -l blue 48b4fb 005faf 255e87
            set -l orange e5c07b unused d19a66
            set -l brown bf5e00 803f00 4d2600
            set -l grey abb2bf 999999 2F333D
            set -l white f8f8f0
            set -l black 181A1F
            set -l ruby_red c24038
            set -l go_blue 56b6c2
            ...
            set -x color_repo_dirty $red[2] $white
            set -x color_repo_staged $orange[1] $grey[3]
            ...
            set -x color_username $grey[2] $grey[3] --bold
            set -x color_hostname $grey[2] $grey[3]
            set -x color_rvm $ruby_red $grey[1] --bold
            set -x color_virtualfish $blue[2] $grey[1] --bold
...
function __bobthefish_user_color_scheme_deprecated
    set -q __color_initial_segment_exit
    or set -l __color_initial_segment_exit ffffff ce000f --bold
    set -q __color_initial_segment_su
    or set -l __color_initial_segment_su ffffff 189303 --bold
    set -q __color_initial_segment_jobs
    or set -l __color_initial_segment_jobs ffffff 255e87 --bold
    set -q __color_path
    or set -l __color_path 333333 999999
    set -q __color_path_basename
    or set -l __color_path_basename 333333 ffffff --bold
    set -q __color_path_nowrite
    or set -l __color_path_nowrite 660000 cc9999
    set -q __color_path_nowrite_basename
    or set -l __color_path_nowrite_basename 660000 cc9999 --bold
    set -q __color_repo
    or set -l __color_repo addc10 0c4801
    set -q __color_repo_work_tree
    or set -l __color_repo_work_tree 333333 ffffff --bold
    set -q __color_repo_dirty
    or set -l __color_repo_dirty ce000f ffffff
    set -q __color_repo_staged
    or set -l __color_repo_staged f6b117 3a2a03
    set -q __color_vi_mode_default
    or set -l __color_vi_mode_default 999999 333333 --bold
    set -q __color_vi_mode_insert
    or set -l __color_vi_mode_insert 189303 333333 --bold
    set -q __color_vi_mode_visual
    or set -l __color_vi_mode_visual f6b117 3a2a03 --bold
    set -q __color_vagrant
    or set -l __color_vagrant 48b4fb ffffff --bold
    set -q __color_username
    or set -l __color_username cccccc 255e87 --bold
    set -q __color_hostname
    or set -l __color_hostname cccccc 255e87
    set -q __color_rvm
    or set -l __color_rvm af0000 cccccc --bold
    set -q __color_virtualfish
    or set -l __color_virtualfish 005faf cccccc --bold
    set -q __color_virtualgo
    or set -l __color_virtualgo 005faf cccccc --bold
    set -q __color_desk
    or set -l __color_desk 005faf cccccc --bold
